...
class SAC__Agent_noV:
    ...
    def _get_grads(
        ...
        with tf.GradientTape() as tape:
            ...
            loss_policy = tf.reduce_mean(
                entropy_term - tf.stop_gradient(new_q_func)
            )
            ...
            grad_policy = all_grads[len_q1_tw + len_q2_tw:]

        return (grad_q1, loss_q1), (grad_q2, loss_q2), (grad_policy, loss_policy)
    ...
    def update_step(
        ...
        (grad_q1, loss_q1), (grad_q2, loss_q2), (grad_policy, loss_policy) = self._get_grads(
