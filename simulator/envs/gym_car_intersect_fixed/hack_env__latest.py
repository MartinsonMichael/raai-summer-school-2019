...
class CarRacingHackatonContinuousFixed(gym.Env, EzPickle):
    ...
    def reset(self):
        ...
        self.car = DummyCar(self.world, init_coord, penalty_sections, color=car_color, car_image=self._data_loader.peek_car_image(3))
    ...
    def draw_car(background_image, background_mask, car: DummyCar):
        ...
        car_x = car.hull.position.x / SHOW_SCALE + backgroundImage.shape[0] / 2
        car_y = -1 * car.hull.position.y / SHOW_SCALE + backgroundImage.shape[0] / 2

        print(f'x,y = {car_x}, {car_y}')
